@{
    ...
    FunctionsToExport = @('Get-PSTIECheckerReasons','Get-PSTIEPagedData','Get-PSTIESpecificCheckerDeviances','Get-PSTIEAllDirectoryDeviances','New-PSTenableIE','Update-PSTIEADObjectByCheckerId')
